...
#SBATCH --job-name=compare_new_train_with_mask
#SBATCH --output=compare_new_train_with_mask.out
#SBATCH --error=compare_new_train_with_mask.err
...
--name compare_new_train_with_mask \
